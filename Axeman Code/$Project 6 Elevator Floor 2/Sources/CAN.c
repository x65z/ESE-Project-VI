...
void CANInit(void) {
  ...
  // Set filters
    CANIDAC = FOUR_16BIT_FILTERS;              // Define four 16-bit filters
       ...
       // Define a 16 bit filter for ID 0x101
       ...
       //Try to define another for recieve ID 200-203
       //CANIDAR2 = ACC_CODE_ID200_HIGH; 
       //CANIDMR2 = MASK_CODE_ST_ID_ELEVATOR_HIGH; 
       //CANIDAR3 = ACC_CODE_ID200_LOW;
       //CANIDMR3 = MASK_CODE_ST_ID_ELEVATOR_LOW;
...
interrupt VectorNumber_Vcanrx void CANRxISR(void) {
  ...
  //Save rxdata to the global RxBuff
  
  strcpy(RxBuff, rxdata);
